...
<div class="row bg-light">
  <div class="col-md-10 offset-md-1 my-5">{{-- centro el formulario --}}
    ...
    <div class="lead" id="contactaFooter">
      <p>
        ¿Dónde puedo enviar mis quejas, comentarios y sugerencias?
        Para incidencias técnicas y consultas comerciales puedes escribirnos a: contacto@filmart.com. <br> No realizamos atención telefónica, todas las consultas serán gestionadas a través del email de contacto. 
      </p>
    </div>
